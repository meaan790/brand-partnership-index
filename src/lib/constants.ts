...
export const DIMENSION_SUBS: DimensionSubs = {
  website: [
    { key: "sale_outlet", label: "Sale & Outlet Sections", desc: "Whether brand.com avoids permanent sale tabs, outlet sections, or markdown grids.", anchor5: "No sale sections", anchor1: "Permanent sale sections", prompt: "e.g., Brand runs a permanent 40% outlet section that undercuts our floor price\u2026" },
    { key: "visitor_popups", label: "Visitor Discount Popups", desc: "Whether brand.com avoids aggressive sign-up popups and cart-abandonment discounts.", anchor5: "No discount popups", anchor1: "Heavy discount popups", prompt: "e.g., 15% sign-up popup for every new visitor, plus 20% abandoned-cart emails\u2026" },
    { key: "flash_cadence", label: "Flash Sale Cadence", desc: "How often brand.com runs short, time-limited promotional pricing that undercuts retailer windows.", anchor5: "Rare flash sales", anchor1: "Constant flash sales", prompt: "e.g., Weekly flash sales every Friday that drive customers away from stores\u2026" },
    { key: "dtc_cashback", label: "DTC Cashback Promotions", desc: "Whether brand.com runs cashback offers only at its own checkout, capturing retail demand.", anchor5: "No DTC cashback", anchor1: "DTC-only cashback", prompt: "e.g., Brand offers permanent 10% Rakuten cashback, making their DTC price always lower than our shelf price\u2026" },
  ],
  pricing: [
  ...
  local: [
    { key: "local_stock", label: "Local Stock on Product Pages", desc: "Real-time retailer inventory shown on each product page, with a buy-from-this-store option.", anchor5: "Live retailer stock", anchor1: "No stock shown", prompt: "e.g., Brand.com shows no retailer stock or \u2018find in store\u2019 link on product pages\u2026" },
