...
window.DIMENSION_SUBS = {
  website: [
    { key: "sale_outlet",    label: "Sale & Outlet Sections",
      desc: "Whether brand.com avoids permanent sale tabs, outlet sections, or markdown grids.",
      anchor5: "No sale sections",
      anchor1: "Permanent sale sections",
    ...
    { key: "visitor_popups", label: "Visitor Discount Popups",
      desc: "Whether brand.com avoids aggressive sign-up popups and cart-abandonment discounts.",
      anchor5: "No discount popups",
      anchor1: "Heavy discount popups",
    ...
    { key: "dtc_cashback",   label: "DTC Cashback Promotions",
      desc: "Whether brand.com runs cashback offers only at its own checkout, capturing retail demand.",
      anchor5: "No DTC cashback",
      anchor1: "DTC-only cashback",
  ...
  pricing: [
    { key: "unauthorized_policing", label: "Unauthorized Reseller Policing",
      ...
      anchor5: "Strict MAP enforcement",
      anchor1: "MAP not enforced",
    ...
    { key: "reseller_comp",         label: "Authorized Reseller Compliance",
      ...
      anchor5: "Consistent pricing",
      anchor1: "Pricing chaos",
    ...
    { key: "price_stable",          label: "Wholesale Price Stability",
      ...
      anchor1: "Constant price changes",
  ...
  local: [
    { key: "local_stock",       label: "Local Stock on Product Pages",
      ...
      anchor5: "Live retailer stock",
      anchor1: "No stock shown",
    ...
    { key: "finder_visibility", label: "Store Finder Visibility",
      desc: "\u2018Find a retailer\u2019 link in primary navigation, footer, and contextual placements.",
      anchor5: "Prominent site-wide",
      anchor1: "Buried or absent",
      prompt: "e.g., Dealer locator is buried three clicks deep in the footer\u2026" },
    { key: "dealer_accuracy",   label: "Dealer Database Accuracy",
      desc: "Quality of the retailer database \u2014 searchable, filterable, current, and accurate.",
      anchor5: "Clean accurate data",
      anchor1: "Stale wrong data",
    ...
    { key: "cashback_routing",  label: "Cashback Routing to Retail",
      ...
      anchor5: "Active retail cashback",
      anchor1: "DTC cashback only",
  ...
  floor: [
    { key: "coop_marketing",    label: "Co-op Marketing Programs",
      ...
      anchor5: "Generous co-op funds",
      anchor1: "No co-op funds",
    ...
    { key: "mobile_incentives", label: "Mobile Incentives & Education",
      ...
      anchor5: "Active mobile training",
      anchor1: "No mobile programs",
    ...
    { key: "rep_merch",         label: "Rep & Merchandising Support",
      ...
      anchor5: "Active rep cadence",
      anchor1: "No rep support",
  ...
  pro: [
    { key: "eligibility",      label: "Pro Deal Eligibility",
      ...
      anchor5: "Strict verified gating",
      anchor1: "Open to anyone",
    ...
    { key: "insider_controls", label: "Insider Discount Controls",
      ...
      anchor5: "Controlled and enforced",
      anchor1: "Codes shared freely",
    ...
    { key: "discount_depth",   label: "Pro Deal Discount Depth",
      ...
      anchor5: "Above wholesale cost",
      anchor1: "Undercuts retailer cost",
